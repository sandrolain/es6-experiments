# ES6 Experiments <i style="font-size: 0.5em">(with secret-lab)</i>

Here you will find a collection of small experimental scripts using the new features of ES6. You can consider them an exercise in style, or if you find them useful to use them in your work.

At the moment we have in the laboratory:
